...
QT_MOC_LITERAL(1, 11, 17), // "willyFinishedMove"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "RenderArea\0willyFinishedMove\0"
};
...
void RenderArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->willyFinishedMove(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject RenderArea::staticMetaObject = {
    { &QVideoWidget::staticMetaObject, qt_meta_stringdata_RenderArea.data,
...
void *RenderArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ScreenDrawer"))
        return static_cast< ScreenDrawer*>(this);
